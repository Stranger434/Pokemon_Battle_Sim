class Program
{
    static void Main(string[] args)
    {
        ...
        while (!quit)
        {
            ...
            // Maak Pokémon aan
            Pokemon pokemon1 = new Squirtle("Squ", Type.Water, Type.Fire);
            Pokemon pokemon2 = new Bulbasaur("Bulba", Type.Grass, Type.Fire);
            Pokemon pokemon3 = new Charmander("Char", Type.Fire, Type.Water);
            ...
            Console.WriteLine($"Totale gevechten: {Arena.TotalBattles}");
            Console.WriteLine($"Totale rondes: {Arena.TotalRounds}");
